...
const ClassedSubHeader = classed("h1", "flex w-full text-lg md:text-xl font-light uppercase")
const ClassedHeader = classed("h4", "flex text-3xl md:text-6xl font-semibold")
                ...
                <div className="flex flex-col justify-center gap-10">
                    <div className="flex flex-col gap-2 px-4">
                        ...
                        <div className="flex flex-col md:flex-row whitespace-nowrap">
                            ...
                            <span className="text-3xl md:text-6xl font-semibold md:pl-2 text-orange-400">Hand</span>
                        </div>
                    </div>
