        ...
        <div className="flex flex-col  items-center md:justify-center bg-gradient-to-tl from-blue-dark to-blue-950 text-slate-50  pt-10 pb-20  gap-16">
            ...
            <div className="flex flex-col md:flex-row items-center md:justify-center gap-24">
                <div className="flex flex-col items-center w-52">
                    <span className="text-7xl font-bold hover:bg-gradient-to-tr hover:from-orange-500 hover:to-orange-400 hover:bg-clip-text hover:text-transparent">{units}+</span>
                    <span className="text-3xl font-thin">Einheiten</span>
                </div>
                <div className="flex flex-col items-center w-80">
                    <span className="text-7xl font-bold hover:bg-gradient-to-tr hover:from-orange-500 hover:to-orange-400 hover:bg-clip-text hover:text-transparent">{years} Jahre</span>
                    <span className="text-3xl font-thin">Expertise</span>
                </div>
                <div className="flex flex-col items-center w-52">
                    <span className="text-7xl font-bold hover:bg-gradient-to-tr hover:from-orange-500 hover:to-orange-400 hover:bg-clip-text hover:text-transparent">{objects}+</span>
